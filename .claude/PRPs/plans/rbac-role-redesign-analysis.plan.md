...
- ⛔ **Role-assignment dropdown** in user admin: surface the 7 new roles + an area picker for area_hr.
- ⛔ **Lock hard-enforcement** (backend): gate mutating candidate handlers to require the lock (currently advisory).
- ⛔ nav polish + full visual UAT.
